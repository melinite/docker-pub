 ...
 *
 *      3/5/2015
 *      disablefilebuffer option for windows memory mapped file issue
 *      patched by David Seong <melinite@gmail.com>
 *
 *      to resolve this issue
 *      http://www.eclipse.org/jetty/documentation/current/troubleshooting-locked-files-on-windows.html
 *      thanks to @AJ MERCER on lucee forums
 *
 */
public class Runner
{
    ...
    protected boolean _useFileMappedBuffer = true;
    ...
    public void usage(String error)
    {
        ...
        System.err.println(" --disablefilebuffer                 - disables jetty memory mapping a file (windows causes locking) only for war deployments");
                    ...
                    if (!runnerServerInitialized) // log handlers not registered, server maybe not created, etc
                    {
                        ...
                        if (_enableStats) 
                        {
                            ...
                            if (handlers.getChildHandlerByClass(StatisticsHandler.class) == null) {
                                ...
                                ServletContextHandler statsContext = new ServletContextHandler(_contexts, "/_jettystats");
